document.addEventListener("DOMContentLoaded", function () {
    ...
    const tickTypes = [
        ...
        },
        {
            ...
            minZoomLevel: 8,
            showLabel: true,
            labelOffset: 15, // Kürzerer Abstand für 5-Minuten-Ticks
    ...
    //     let fontSize;
    //     if (zoomLevel <= 4) {
    //         fontSize = 26 / zoomLevel; // Größere Schriftgröße bei Zoomlevel 1–4
    //     } else {
        ...
        for (let i = firstTick; i <= endMinute; i += tickType.interval) {
            ...
            if (showLabel) {
                ...
                if (!existingLabel) {
                    ...
                    label.style.fontSize = tickType.fontSize + 'px'; // Feste Schriftgröß
